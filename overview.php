...
<input type="hidden" name="download_filter" id="download_filter" value="">
    ...
    <form action="<?= PluginEngine::getURL('alumnidomainplugin') ?>" onSubmit="jQuery('#domain_filter').val(jQuery('#overview-table_filter').find('input').val());">
<button type="submit"> - Verwalte Domains - </button>
<input type="hidden" name="domain_filter" id="domain_filter" value="">
</form>
</div>
